...
import { Box, Center, Flex, Heading, Image, Input,Text } from "@chakra-ui/react";
...
const Navbar = () => {
  return (
    <>
      <Center>
        <Box w="100%"  bgColor={"#fff"} position="fixed" top={0} left={0} right={0} zIndex={1000} >
          <Box>
            <Center>
              <Flex
                w={"80%"}
          ...
          ><Popover>
            ...
            >
              ...
              <Heading
              fontSize="16px" _hover={{ fontSize: "18px", transition: "0.3s" }}
                fontWeight={600}
                mr={35}
                cursor={"pointer"}
                // fontSize={"16px"}
